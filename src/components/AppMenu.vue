<template>
  <div class="container col-md-10 col-lg-8 col-xl-6 d-flex justify-content-between align-items-center p-3">
    <div>
      {{ countTodoLeft }} left
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters(['countTodoLeft', 'filterType', 'isOneCompleted'])
  }
}
</script>
